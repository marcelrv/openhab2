...
public class CloudConnector {
    ...
    public String sendRequest(String path, String country, String param) throws MiCloudException {
        final @Nullable MiCloudConnector cl = this.cloudConnector;
        if (cl == null || !isConnected()) {
            throw new MiCloudException("Cannot execute request. Cloud service not available");
        }
        return cl.request(path.startsWith("/") ? path : "/" + path, country.trim().toLowerCase(), param);
    }
